...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`voucher` (
  ...
  `company_id` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` TIMESTAMP NOT NULL DEFAULT "2015-01-01 00:00:00" COMMENT '修改时间',
  PRIMARY KEY (`id`)  COMMENT '',
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`subject_length` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT ' 主键',
  `length` INT(11) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`users` (
  `username` VARCHAR(256) NULL DEFAULT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`authorities` (
  `username` VARCHAR(256) NULL DEFAULT NULL COMMENT '',
  `authority` VARCHAR(256) NULL DEFAULT NULL COMMENT '')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`login_history` (
  ...
  PRIMARY KEY (`id`)  COMMENT '',
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)  COMMENT '',
  INDEX `idx_login_time` USING BTREE (`login_time` DESC)  COMMENT '',
  INDEX `idx_login_result` USING BTREE (`login_result` ASC)  COMMENT '')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`subject_balance` (
  ...
  PRIMARY KEY (`id`)  COMMENT '',
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)  COMMENT '',
  UNIQUE INDEX `subject_code_UNIQUE` (`subject_code` ASC, `period_id` ASC)  COMMENT '')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
COMMENT = '科目余额表';
...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`balance_sheet` (
  ...
  `code` BIGINT(20) NULL DEFAULT NULL COMMENT '',
  `parent_code` BIGINT(20) NULL DEFAULT NULL COMMENT '',
  `name` VARCHAR(45) NULL DEFAULT NULL COMMENT '',
  `year_begin_exp` VARCHAR(200) NULL DEFAULT NULL COMMENT '',
  `period_end_exp` VARCHAR(200) NULL DEFAULT NULL COMMENT '',
  `need_sum` INT(2) NULL DEFAULT NULL COMMENT '是否需要合计 0 需要 1 不需要',
  `level` INT(2) NULL DEFAULT NULL COMMENT '',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  `modify_time` TIMESTAMP NOT NULL DEFAULT "2015-01-01 00:00:00" COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)  COMMENT '')
...
CREATE TABLE IF NOT EXISTS `yjz_prod`.`profit` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` VARCHAR(45) NULL DEFAULT NULL COMMENT '项目',
  `row_num` INT(11) NULL DEFAULT NULL COMMENT '行次',
  `year_exp` VARCHAR(200) NULL DEFAULT NULL COMMENT '本年累计金额',
  `month_exp` VARCHAR(200) NULL DEFAULT NULL COMMENT '本月金额',
  `last_year_exp` VARCHAR(200) NULL DEFAULT NULL COMMENT '上年金额',
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
  `modify_time` TIMESTAMP NOT NULL DEFAULT "2015-01-01 00:00:00" COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)  COMMENT '')
...
USE `yjz_prod`$$
CREATE DEFINER = CURRENT_USER TRIGGER `yjz_prod`.`profit_BEFORE_UPDATE` BEFORE UPDATE ON `profit` FOR EACH ROW
BEGIN
	SET NEW.`modify_time` = NOW();
END
$$
