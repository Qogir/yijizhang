...
@Aspect
@Configuration
public class BalanceSheetControllerActlog extends ActionLogAopConfiguration{
		...
		@Pointcut("execution(* cn.ahyc.yjz.controller.BalanceSheetController.*(..))")
		...
		public void before(JoinPoint point) {
				...
				switch (method){
						case("main"):
								actionLog = actionLog("打开资产负债表页面","开始","",point);
								break;
						default:
								break;
				}
		...
		public void after(JoinPoint point) {
				...
				switch (method){
						case("main"):
								actionLog = actionLog("打开资产负债表页面","结束","",point);
								break;
						default:
								break;
				}
