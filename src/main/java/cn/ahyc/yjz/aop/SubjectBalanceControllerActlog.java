...
@Aspect
@Configuration
public class SubjectBalanceControllerActlog extends ActionLogAopConfiguration{
		...
		@Pointcut("execution(* cn.ahyc.yjz.controller.SubjectBalanceController.*(..))")
		...
		public void before(JoinPoint point) {
				...
				switch (method){
						case("subjectBalanceList"):
								actionLog = actionLog("查看科目余额表","开始","",point);
								break;
						default:
								break;
				}
		...
		public void after(JoinPoint point) {
				...
				switch (method){
						case("subjectBalanceList"):
								actionLog = actionLog("查看科目余额表","结束","",point);
								break;
						default:
								break;
				}
