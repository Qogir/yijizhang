...
@Aspect
@Configuration
public class SearchDetailControllerActlog extends ActionLogAopConfiguration{
		...
		@Pointcut("execution(* cn.ahyc.yjz.controller.SearchDetailController.*(..))")
		...
		public void before(JoinPoint point) {
				...
				switch (method){
						case("main"):
								actionLog = actionLog("打开明细账页面","开始","",point);
								break;
						case("submitNow"):
								actionLog = actionLog("查看明细账数据","开始","",point);
								break;
						default:
								break;
				}
		...
		public void after(JoinPoint point) {
				...
				switch (method){
						case("main"):
								actionLog = actionLog("打开明细账页面","结束","",point);
								break;
						case("submitNow"):
								actionLog = actionLog("查看明细账数据","结束","",point);
								break;
						default:
								break;
				}
