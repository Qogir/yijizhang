...
@Aspect
@Configuration
public class SearchTrialBalanceControllerActlog extends ActionLogAopConfiguration{
		...
		@Pointcut("execution(* cn.ahyc.yjz.controller.SearchTrialBalanceController.*(..))")
		...
		public void before(JoinPoint point) {
				...
				switch (method){
						case("main"):
								actionLog = actionLog("打开试算平衡表页面","开始","",point);
								break;
						case("subjectBalanceList"):
								actionLog = actionLog("查看试算平衡表数据","开始","",point);
								break;
						default:
								break;
				}
		...
		public void after(JoinPoint point) {
				...
				switch (method){
						case("main"):
								actionLog = actionLog("打开试算平衡表页面","结束","",point);
								break;
						case("subjectBalanceList"):
								actionLog = actionLog("查看试算平衡表数据","结束","",point);
								break;
						default:
								break;
				}
